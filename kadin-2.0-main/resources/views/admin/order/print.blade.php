...
<div class="print" id="print2">
    ...
    <div class="container">
        <div class="row container" style="margin-top: 20px" >
            <div class="col-8">
                <p style="font-size: 30px;">SENHA</p>
                <p style="font-size: 30px;">MESA</p>
            </div>
            <div class="col">
                <p style="font-size: 40px; margin-bottom: 25px">{{ $coupon['key'] }}</p>
                <p style="font-size: 40px; margin-bottom: 25px">{{ $coupon['desk'] }}</p>
            </div>
        </div>
        <hr style="margin-top: 1px">
